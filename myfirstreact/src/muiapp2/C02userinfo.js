...
export default function AccountInfo() {
    ...
    const authdata=()=>{const mytoken=localStorage.getItem('userToken')
if (mytoken){
                ...
                <Grid item md={6}> 
                    <Paper elevation={1} className={classes.accpaper}>
                        <Box className={classes.avtbox}>
                            ...
                            <Typography variant="h5" gutterBottom>/*myemail ?succ.data.userinfo.name: "No Name"*/</Typography>
                            <Typography variant="body2" gutterBottom>/*myemail?succ.data.userinfo.country:"no country"*/</Typography>
