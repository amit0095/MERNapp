...
import { fetchedData, updtemail,updtphone,updtwebsite } from '../reducers/newUserReducerHaiYe'
  ...
  return (
    <Container>
        <Box>
            ...
            <Typography variant="body2">this is my phone :  {data.apidata.website}</Typography>
            <FormControl variant='standard'>
                <InputLabel>phoneno</InputLabel>
                <Input onChange={e=>setnewphone(e.target.value)}></Input>
            </FormControl>
